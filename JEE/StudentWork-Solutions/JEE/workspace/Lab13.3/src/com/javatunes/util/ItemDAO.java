...
public class ItemDAO
{
   ...
   throws SQLException
   {
      ...
      String sqlCreate = "INSERT INTO Item(ITEM_ID, Title, Artist, ReleaseDate, ListPrice, Price) VALUES (?, ?, ?, ?, ?, ?)";   
