...
"C:\Program Files (x86)\Java\jre1.6.0_24\bin\java" -Dij.driver=org.apache.derby.jdbc.ClientDriver -Dij.database=%DB_NAME%;create=true -Dij.user=guest -Dij.password=password org.apache.derby.tools.ij dbCreate.sql
