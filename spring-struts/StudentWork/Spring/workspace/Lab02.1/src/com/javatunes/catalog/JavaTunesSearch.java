...
// TODO - Make sure JavaTunesSearch implements SearchUtility
public class JavaTunesSearch implements SearchUtility {

   // catalog of MusicItem objects
   private static Collection c_catalog = new ArrayList();
   ...
   public MusicItem findById(Long id)
   {
      ...
      for (Iterator i = c_catalog.iterator(); i.hasNext(); )
      {
   ...
   {
      c_catalog.add(new MusicItem(new Long(id), num, title, artist,
